...
o	Large $NetCustDeltaFlow_Und$ can confirm directional trends seen in $TW-LAF$ or $VAPI-FA$.
•	Relationship to other v2.5 Components:
...
o	If such granular signed Greek flow fields are not available from get_chain, the calculation of these precise Net Customer Greek Flows (and thus td_gib from $NetCustGammaFlow_Und$) would be compromised and rely on the less accurate get_und fields mentioned in v2.4, or proxies.
•	Evolution from v2.4:
